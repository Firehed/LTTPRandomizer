...
enum Item: UInt8, CustomStringConvertible {
    ...
    case RedPotion = 0x2b // does nothing if no bottle
    case GreenPotion = 0x2c // does nothing if no bottle
    case BluePotion = 0x2d // does nothing if no bottle
    case RedPotion2 = 0x2e // does nothing if no bottle
    case GreenPotion2 = 0x2f // does nothing if no bottle
    case BluePotion2 = 0x30 // does nothing if no bottle
    case TenBombs = 0x31
    case BigKey = 0x32
    case Map = 0x33
    case OneRupee = 0x34
    ...
    case Bee2 = 0x3c // does nothing if no bottle
    case Fairy = 0x3d // does nothing if no bottle
    ...
    case GoodBee = 0x48 // does nothing if no bottle
